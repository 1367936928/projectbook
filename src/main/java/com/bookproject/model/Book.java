...
public class Book {
    ...
    private Set<User> users;  //收藏了该书籍的用户

    public Book() {
    }

    public Book(int clickCount, int grade, String bookName, String author, String newDate, String chapterCount, String bookINtro, String bookPath) {
    ...
    public Book(int id, int clickCount, int grade, String bookName, String author, String newDate, String chapterCount, String bookINtro, String bookPath, Set<Comment> comments, Set<User> users) {
        this.id = id;
        ClickCount = clickCount;
        Grade = grade;
        BookName = bookName;
    ...
    @JoinTable(name = "bh_user_book",joinColumns={@JoinColumn(name="book_id")},inverseJoinColumns={@JoinColumn(name="user_id")})
